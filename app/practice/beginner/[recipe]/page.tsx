//app/practice/beginner/[recipe]/page.tsx
...
export default function PracticeGamePage({
  ...
  //timer effect, counts down from 120 seconds and ends game when it reaches 0
  useEffect(() => {
  ...
  return (
    <main className="game-page">
        ...
        <div className="game-fail-overlay">
          <div className="game-fail-box">
            ...
            <div className="game-fail-actions">
              ...
              <Link href="/practice/beginner" className="game-fail-btn game-fail-btn--back">
                ← BACK TO RECIPES
              </Link>
            </div>
          </div>
      ...
      <header className="game-header">
        <Link href="/practice/beginner" className="btn-back" aria-label="Back">←</Link>
